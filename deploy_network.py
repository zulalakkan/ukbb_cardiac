...
tf.app.flags.DEFINE_string('testset_dir', '/tmp/github/test',
                           'Path to the test set directory, under which images are organised \
                            in different subdirectories for each subject.')
tf.app.flags.DEFINE_string('dest_dir', '/tmp/github/output',
                           'Path to the destination directory, where the segmentations will be saved.')
tf.app.flags.DEFINE_string('model_path',
                           '/tmp/github/model/FCN_sa_level5_filter16_22333_Adam_batch2_iter50000_lr0.001.ckpt-50000',
    ...
    with tf.Session() as sess:
        ...
        for data in data_list:
            ...
            if FLAGS.process_seq:
                ...
                pad_x, pad_y = (X2 - X) / 2, (Y2 - Y) / 2
                image = np.pad(image, ((pad_x, pad_x), (pad_y, pad_y), (0, 0), (0, 0)), 'constant')
                ...
                for t in range(T):
                    ...
                    pred_fr = pred_fr[pad_x:pad_x + X, pad_y:pad_y + Y]
                    pred[:, :, :, t] = pred_fr
                ...
                for fr in ['ED', 'ES']:
                    ...
                    pred = pred[pad_x:pad_x + X, pad_y:pad_y + Y]
